...
def generate_launch_description():
        ...
        "robot_description": ParameterValue(
            Command([
                ...
                PathJoinSubstitution(
                    [FindPackageShare("patient_cart_description"), "urdf", "patient_cart.classic.urdf.xacro"]
                )
            ]),
            value_type=str
        )
    ...
    controller_file = "patient_cart.classic.controllers.yaml"

    # Path to the controller configuration file
    controller_config = PathJoinSubstitution(
        [FindPackageShare("patient_cart_description"), "config", controller_file]
    )
    ...
    joint_position_controller = Node(
        package="patient_cart_description",
        executable="patient_cart_joint_controller",
        output="screen",
        parameters=[{'use_sim_time': True}]
    )
