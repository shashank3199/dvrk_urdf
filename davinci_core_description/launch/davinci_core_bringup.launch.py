...
def generate_launch_description():
    ...
    controller_file = "davinci_core.controllers.yaml"

    # Path to the controller configuration file
    controller_config = PathJoinSubstitution(
        [FindPackageShare("davinci_core_description"), "config", controller_file]
    )
    ...
    joint_position_controller = Node(
        package="davinci_core_description",
        executable="davinci_core_joint_controller",
        output="screen",
        parameters=[{'use_sim_time': True}]
    )
